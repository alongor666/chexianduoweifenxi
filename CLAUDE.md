...
### 📚 核心规范与模板
- **规范总览**: `开发文档/00_standards/README.md` - 🆕 知识库规范、文档模板、AI协作方法论
  - [协作约定](开发文档/00_standards/conventions.md) - 代码优先原则、文档规范
  - [AI协作方法论](开发文档/00_standards/ai_knowledge_methodology.md) - 知识工程方法论
  - [元数据规范](开发文档/00_standards/doc_meta_standard.md) - YAML Frontmatter标准
  - [文档模板](开发文档/00_standards/templates/) - 功能卡片、ADR、技术设计模板
