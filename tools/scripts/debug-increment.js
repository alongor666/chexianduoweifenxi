...
// 计算增量
const increment =
  week44Cumulative.signed_premium_yuan - week43Cumulative.signed_premium_yuan
const incrementWan = Math.round(increment / 10000)

console.log(
  '第43周累计签单保费:',
  week43Cumulative.signed_premium_yuan / 10000,
  '万元'
)
console.log(
  '第44周累计签单保费:',
  week44Cumulative.signed_premium_yuan / 10000,
  '万元'
)
