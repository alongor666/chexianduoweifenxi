...
export class InsuranceRecord {
  ...
  toRawData(): RawInsuranceData {
    return {
      ...
      vehicle_insurance_grade: this.vehicleInsuranceGrade,
      highway_risk_grade: this.highwayRiskGrade,
      large_truck_score: this.largeTruckScore,
      small_truck_score: this.smallTruckScore,
