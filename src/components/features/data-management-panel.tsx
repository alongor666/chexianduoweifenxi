...
export function DataManagementPanel() {
  const [activeSubTab, setActiveSubTab] = useState<'upload' | 'export' | 'process'>('upload')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <Tabs value={activeSubTab} onValueChange={(v) => setActiveSubTab(v as 'upload' | 'export' | 'process')}>
